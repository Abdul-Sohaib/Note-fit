...
const Strengthbeg = () => {
  return (
    <div className=''>
    <h3 className="text-3xl justify-center font-heading font-bold underline text-white tracking-wider">Beginner </h3>
...
<span className='my-3 underline text-white font-extrabold' data-aos="fade-up">Day 2: Rest or Light Activity</span>

<span className='my-3 underline text-white font-extrabold'data-aos="fade-down" >Day 3: Full Body</span>
...
<span className='my-3 underline text-white font-extrabold'data-aos="fade-down" >Day 5: Full Body</span>
...
<span className='my-3 underline text-white font-extrabold' data-aos="fade-up">Day 6: Rest or Light Activity</span>
