...
const Strengthind = () => {
  return (
    <div className=''>
    <h3 className="text-4xl text-customBlack justify-center font-headingg font-bold underline tracking-wider">Intermediate </h3>
...
<li>2.(Bent Over Rows: 4 sets of 8 reps).</li> font-body
<li>3.(Shoulder Press: 4 sets of 10 reps).</li>
<li>4.(Bicep Curls: 3 sets of 12 reps).</li>
<li>5.(Tricep Dips: 3 sets of 12 reps).</li>
</ol>
<span className='my-3  text-customBlack  font-headingg' data-aos="fade-up">Day 2: Lower Body</span>
<ol className='flex flex-col gap-2 justify-center items-start mx-3 font-body' data-aos="fade-up">
...
<span className='my-3  text-customBlack  font-headingg'data-aos="fade-down" >Day 3: Rest or Active Recovery</span>
...
<span className='my-3  text-customBlack  font-headingg'data-aos="fade-down" >Day 5: Rest or Active Recovery</span>

<span className='my-3  text-customBlack  font-headingg' data-aos="fade-up">Day 6: Cardio/HIIT</span>
