...
const Strengthadv = () => {
  return (
    <div className=''>
    <h3 className="text-3xl text-white justify-center font-heading font-bold underline tracking-wider" >Advanced </h3>
...
<ol className='flex flex-col gap-4 justify-center items-start mx-3' data-aos="fade-up">
...
<span className='my-3 underline text-white font-extrabold' data-aos="fade-up">Day 2: Back and Biceps</span>
...
<span className='my-3 underline text-white font-extrabold'data-aos="fade-down" >Day 3: Legs</span>
...
<span className='my-3 underline text-white font-extrabold' data-aos="fade-up">Day 4: Shoulders and Abs</span>
<ol className='flex flex-col gap-2 justify-center items-start mx-3' data-aos="fade-up">
...
<span className='my-3 underline text-white font-extrabold'data-aos="fade-down" >Day 5: Cardio/HIIT</span>
...
<span className='my-3 underline text-white font-extrabold' data-aos="fade-up">Day 6: Full Body</span>
<ol className='flex flex-col gap-2 justify-center items-start' data-aos="fade-up"><li>1.(Combination of compound exercises (e.g., Squats, Deadlifts, Bench Press) at lower intensity).</li></ol>
